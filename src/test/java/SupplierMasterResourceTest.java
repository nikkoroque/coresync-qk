...
public class SupplierMasterResourceTest {
    ...
    void testSupplierLifeCycle() {
        SupplierMaster mockNewSupplier = new SupplierMaster(0, "999", "Kraft Corp", "Gardena CA", "18009584665", "email@email.com", "458658245SC", "15496875461231", OffsetDateTime.parse("2024-12-24T05:11:20.070Z"), "QKDEV",OffsetDateTime.parse("2024-12-24T05:11:20.070Z"), "QKDEV");
        ...
        SupplierMaster mockUpdateSupplier = new SupplierMaster(newSupplierId, "999", "Kraft Inc", "Gardena CA", "18009584665", "email@email.com", "458658245SC", "15496875461231", mockNewSupplier.getCreationDate(), mockNewSupplier.getCreatedByUser(),OffsetDateTime.parse("2024-12-24T05:11:20.070Z"), "QKDEV");
