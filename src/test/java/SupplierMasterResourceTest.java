...
public class SupplierMasterResourceTest {
    ...
    void testSupplierLifeCycle() {
        SupplierMaster mockNewSupplier = new SupplierMaster(0, "999", "Kraft Corp", "Gardena CA", "Gardena", "CA", "90234-09829", "USA", "Y", "18009584665", "email@email.com", "458658245SC", "ACTIVE", 10, 5, 10, "15496875461231", OffsetDateTime.now(), "QKDEV",OffsetDateTime.now(), "QKDEV");
        ...
        SupplierMaster mockUpdateSupplier = new SupplierMaster(newSupplierId, "999", "Kraft Inc", "Gardena CA", "Gardena", "CA", "90234-09829", "USA", "Y", "18009584665", "email@email.com", "458658245SC", "ACTIVE", 10, 5, 10, "15496875461231", mockNewSupplier.getCreationDate(), mockNewSupplier.getCreatedByUser(),OffsetDateTime.now(), "QKDEV");
