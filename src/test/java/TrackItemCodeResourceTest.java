...
public class TrackItemCodeResourceTest {
    ...
    void testTrackItemCodeLifeCycle() {
        //Add Track Item Code
        TrackItemCode mockNewItemCode = new TrackItemCode(0, "G", "Tracked by License Plate", OffsetDateTime.now(), "QKDEV",OffsetDateTime.now(),"QKDEV");
        ...
        TrackItemCode mockUpdateItemCode = new TrackItemCode(newItemCodeId, "G", "Tracked by License Plates", mockNewItemCode.getCreationDate(), mockNewItemCode.getCreatedByUser(), OffsetDateTime.now(),"QKTUDEV");
