...
@Entity
@Table(name = "track_item_code", schema = "inventory_mgt", catalog = "coresync")
public class TrackItemCode {
    ...
    public TrackItemCode() {

    }
    public TrackItemCode(int id, String code, String description, OffsetDateTime creationDate, String createdByUser, OffsetDateTime lastUpdateDate, String lastUpdatedByUser) {
        this.id = id;
        this.code = code;
