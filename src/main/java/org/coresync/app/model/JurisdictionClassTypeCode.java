...
public class JurisdictionClassTypeCode {
    ...
    public JurisdictionClassTypeCode() {

    }

    public JurisdictionClassTypeCode(int id, String classTypeCode, String description, OffsetDateTime creationDate, String createdByUser, OffsetDateTime lastUpdateDate, String lastUpdatedByUser) {
        this.id = id;
