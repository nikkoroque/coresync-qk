...
public class ShelfLifeTypeCode {
    ...
    public ShelfLifeTypeCode() {

    }

    public ShelfLifeTypeCode(int id, String code, String description, OffsetDateTime creationDate, String createdByUser, OffsetDateTime lastUpdateDate, String lastUpdatedByUser) {
        this.id = id;
        this.code = code;
